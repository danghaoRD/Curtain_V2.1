...
#define 	TYPE_HARDWARE_SWITCH		CURTAINS_TOUCH_SWITCH
	...
	#define RD_HEADER_CONTROL_CURTAIN			(0x0011)
	#define RD_HEADER_CURTAIN_SAVE_SCENE		(0x0111)
	#define RD_HEADER_CURTAIN_DELETE_SCENE		(0x0211)
	#define RD_HEADER_CURTAIN_STT				(0x0311)
	#define RD_HEADER_CURTAIN_CALIB				(0x0411)


	#define RD_HEADER_SENSOR_CURTAIN_STT		(0x0011)
#endif
...
typedef struct
		{
			uint8_t Header[2];
			uint8_t Control_Taget;  // 0- Off, 1-On, 2Stop
			uint8_t CurtainStt;  // % open of curtain
			uint8_t Future[4];
		} STT_Curtain_Mess;
STT_Curtain_Mess STT_Curtain_Mess_Config;
