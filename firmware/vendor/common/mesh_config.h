...
#define LIGHT_TYPE_SEL				LIGHT_TYPE_PANEL
		#endif
	#else
#define LIGHT_TYPE_SEL				LIGHT_TYPE_NONE//RD_EDIT Type light LIGHT_TYPE_CT	//
	#endif
#endif
#endif
...
#define MD_SENSOR_EN	   1// RD_EDIT Sensor Opcode Enable (MD_SENSOR_SERVER_EN || MD_SENSOR_CLIENT_EN)
...
#define MAX_LPN_NUM					16   // should be less than or equal to 16  // RD_EDIT Friend MAX
...
#define			IRQ_TIME1_INTERVAL			    (2000) 	// unit: us RD_EDIT Set time interrupt 5ms
#define			IRQ_GPIO_ENABLE  			    0			// RD_EDIT enable Interrupt GPIO0
