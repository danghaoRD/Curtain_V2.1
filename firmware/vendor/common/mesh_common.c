...
#include "../mesh/RD_MessData/RD_MessData.h"
#include "../mesh/RD_SwitchAC4Ch_Touch/RD_SwitchAC4Ch_Touch.h"
#include "../mesh/RD_Flash/RD_Flash.h"

extern RD_TYPE_MAINDEVICE 				TYPE_MAINDEVICE;
extern RD_TYPE_SWITCH					TYPE_SWITCH;
extern RD_TYPE_TOUCH_SWITCH				TYPE_TOUCH_SWITCH;
#if DU_ENABLE
#include "user_du.h"
#endif
#if MI_API_ENABLE
...
//	}
	tbl_scanRsp.rsv_user[0] = TYPE_MAINDEVICE;
	tbl_scanRsp.rsv_user[1] = TYPE_SWITCH;
	tbl_scanRsp.rsv_user[2] = TYPE_TOUCH_SWITCH;
